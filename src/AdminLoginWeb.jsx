...
export default function AdminLoginWeb({ school, schoolCode, onLogin, onBack }) {
      ...
      >
        <div style={{ width: "100%", maxWidth: 500 }}>
          ...
          >
            ...
            >
              💡 Varsayılan kullanıcı adı: <strong>mudur</strong>
            </div>
          </div>
          ...
          >
            Okula yapacağınız istemiçin →{" "}
            <a href="mailto:info@taskipro.com" style={{ color: C.accent, textDecoration: "none" }}>
              info@taskipro.com
            </a>
          </div>
        </div>
